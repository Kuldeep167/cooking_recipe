...
import 'package:cooking_recipe/views/screens/full_screen_image.dart';
import 'package:cooking_recipe/views/utils/AppColor.dart';
import 'package:cooking_recipe/views/widgets/ingredient_tile.dart';
import 'package:cooking_recipe/views/widgets/review_tile.dart';
import 'package:cooking_recipe/views/widgets/step_tile.dart';
      ...
      appBar: PreferredSize(
        ...
        child: AnimatedContainer(
          ...
          child: AppBar(
            ...
            elevation: 0,
            centerTitle: true,
            title: Text('', style: TextStyle(fontFamily: 'inter', fontWeight: FontWeight.w400, fontSize: 16)),
            leading: IconButton(
