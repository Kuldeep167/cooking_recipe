import 'dart:ui';
import 'package:cooking_recipe/views/screens/recipe_detail_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import '../../models/core/recipe.dart';


class IndianRecipeCard extends StatelessWidget {
  final Recipe data;
  IndianRecipeCard({required this.data});
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        SvgPicture.asset(
                          'assets/icons/fire-filled.svg',color: Colors.white,
                          width: 12,
                          height: 12,
                        ),
                        Container(
